...
yyyyyy(isinf(yyyyyy)) = NaN;
x = {y,yyy,yyyyyy} ;
yline(0,'k')
motiflabels = {'0','I','II','III','IV','V','VI','VII','VIII','IX','X','XI','XII','XIII'};
boxplotGroup(x,'Colors','krb','interGroupSpace',3,'PrimaryLabels',{'','',''},'SecondaryLabels',motiflabels)
...
yline(0,'k')
motiflabels = {'0','I','II','III','IV','V','VI','VII','VIII','IX','X','XI','XII','XIII'};
boxplotGroup(x,'Colors','kg','interGroupSpace',5,'PrimaryLabels',{'',''},'SecondaryLabels',motiflabels)
ylabel('$\frac{A/T Pharma}{A/T Baseline} - 1$','Interpreter','latex')
...
yline(0,'k')
motiflabels = {'0','I','II','III','IV','V','VI','VII','VIII','IX','X','XI','XII','XIII'};
boxplotGroup(x,'Colors','km','interGroupSpace',5,'PrimaryLabels',{'',''},'SecondaryLabels',motiflabels)
ylabel('$\frac{A/T Pharma}{A/T Baseline} - 1$','Interpreter','latex')
ylim([-1.5 2.5])
...
yline(1,'k')
motiflabels = {'0'};
boxplotGroup(x,'Colors','krmgb','interGroupSpace',5,'PrimaryLabels',{'','','','',''},'SecondaryLabels',motiflabels)
