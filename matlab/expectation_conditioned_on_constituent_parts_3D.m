function [super_noise] = expectation_conditioned_on_constituent_parts_3D(actual, raster,x_window, y_window, time_window)
     
    [expected,unscaled_expected, p] = theoretical_spiking_expectation_3D(raster, x_window, y_window, time_window);
