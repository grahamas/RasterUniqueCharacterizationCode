...
TT_fig, NN_fig = let freq=0.04, θ=-2π, N_neurons=150, N_times=150,
...
triple_correlation = @btime calculate_unscaled_triple_correlation($raster, $neuron_window, $time_window)
