...
subfig3A, cont_3A = let freq = 0.12, θ=0, noise_amplitude = 0, signal_amplitude=1;
    ...
    plot_network_class_contributions!(contributions_axis, raster, boundary, lag_extents)
...
save(plotsdir("Fig3_$(boundary |> typeof)_$(lag_extents)_$(Dates.format(Dates.now(), "yyyy_mm_dd-HHMMSS")).png"), fig3)
